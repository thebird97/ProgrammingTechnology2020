        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               Player  newValue = model.step(i, j);
                ...
                //button.setText("aa");
                String alma  = newValue.name();
                System.out.println("alma " + alma);
                if(alma.equals("O") ) {
                    System.out.println("xxxx");
                    System.out.println(newValue.name());
                     button.setIcon(new ImageIcon(getClass().getResource("smallbalck.png")));
                      
                } else {
                    System.out.println("y");
                    System.out.println(newValue.name());
                    // Icon icon = new ImageIcon("E:\\editicon.PNG");
                    button.setIcon(new ImageIcon(getClass().getResource("smallwhite.png")));
